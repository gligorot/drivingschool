...
@Data
@Entity
@Table(name = "training_state_theory_test")
public class TrainingStateTheoryTest implements TrainingState {
    ...
    public TrainingStateTheoryTest() {
    }

    public TrainingStateTheoryTest(Training training) {
    ...
    public TrainingStateTheoryTest(Training training, Integer testTries, TrainingTestStatus testPassStatus) {
        this.training = training;
        this.trainingId = training.getId(); // not supposed to be needed?
