...
@Data
@Entity
@Table(name = "theory_test_inter_state_transition")
public class TheoryTestInterStateTransition implements InterStateTransition {
    ...
    public TheoryTestInterStateTransition() {
    }

    public TheoryTestInterStateTransition(Request request) {
