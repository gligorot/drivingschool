...
@Data
@Entity
@Table(name = "range_test_inter_state_transition")
public class RangeTestInterStateTransition implements InterStateTransition {
    ...
    public RangeTestInterStateTransition() {
    }

    public RangeTestInterStateTransition(Request request) {
