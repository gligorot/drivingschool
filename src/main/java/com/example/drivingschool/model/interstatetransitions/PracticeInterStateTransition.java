...
@Data
@Entity
@Table(name = "practice_inter_state_transition")
public class PracticeInterStateTransition implements InterStateTransition {
    ...
    public PracticeInterStateTransition() {
    }

    public PracticeInterStateTransition(Request request) {
